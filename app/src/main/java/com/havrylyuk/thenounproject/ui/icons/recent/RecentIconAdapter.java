...
public class RecentIconAdapter extends BaseRecyclerViewAdapter<RecentIconAdapter.ViewHolder, NounIcon> {

    private Context context;

    @Inject
    public RecentIconAdapter(Context context) {
        this.context = context;
        setData(new ArrayList<NounIcon>());
    }

    @Override
    public RecentIconAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new RecentIconAdapter.ViewHolder(
